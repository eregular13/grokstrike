...
- `az` not found — run `scripts/kali-full-bootstrap.sh`
...
Run `az --help` and tune `az account show {extra}` for your target.

---
*GrokStrike v2 — 2026-06-24T05:48:29.762869+00:00*
