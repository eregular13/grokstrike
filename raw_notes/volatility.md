...
--- STDERR ---
command not found: volatility
```

## What I Learned / Edge Cases / Gotchas
- `volatility` not found — run `scripts/kali-full-bootstrap.sh`
...
Run `volatility --help` and tune `volatility -f /workspace/mem.raw imageinfo {extra}` for your target.

---
*GrokStrike v2 — 2026-06-24T05:48:30.590986+00:00*
