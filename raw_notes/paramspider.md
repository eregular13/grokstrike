...
- `paramspider` not found — run `scripts/kali-full-bootstrap.sh`
...
Run `paramspider --help` and tune `paramspider -d {host} {extra}` for your target.

---
*GrokStrike v2 — 2026-06-24T05:47:40.661456+00:00*
